...
def main():
    ...
    final_table = spark.sql("SELECT userid, movieid, genres, keywords, language, plot, popularity, poster, production_companies, rating, release_year, title, tmdbid, vote_average from split_t   able")
    #final_table.show()

    #Read Data from table to CSV
    final_table.write.csv('table1.csv')
